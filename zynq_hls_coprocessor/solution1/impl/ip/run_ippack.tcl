...
set IPName      "eucDis"
set Version     "1.0"
set DisplayName "Eucdis"
set Revision    "2112469178"
...
set xo_kernel_name "eucDis"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "E:/Magisterio/IPD-432/Tarea_4/zynq_hls_coprocessor/solution1"
set debug_dir "E:/Magisterio/IPD-432/Tarea_4/zynq_hls_coprocessor/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {eucDis_mul_32s_32s_32_2_1
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 RESERVED_3 R 0 "Reserved.  0s on read." } { 10 22 RESERVED_4 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 C R 0x0 "Data signal of C" {{0 32 C R 0 "Bit 31 to 0 of C"}}} {0x14 C_ctrl R 0x0 "Control signal of C" {{0 1 C_ap_vld R 0 "Control signal C_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories "A_0 {base_address 512 range 512} A_1 {base_address 1024 range 512} A_2 {base_address 1536 range 512} A_3 {base_address 2048 range 512} A_4 {base_address 2560 range 512} A_5 {base_address 3072 range 512} A_6 {base_address 3584 range 512} A_7 {base_address 4096 range 512} B_0 {base_address 4608 range 512} B_1 {base_address 5120 range 512} B_2 {base_address 5632 range 512} B_3 {base_address 6144 range 512} B_4 {base_address 6656 range 512} B_5 {base_address 7168 range 512} B_6 {base_address 7680 range 512} B_7 {base_address 8192 range 512}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 144 II x}
...
source -notrace "C:/Xilinx/Vitis_HLS/2021.1/common/scripts/ipxhls.tcl"
