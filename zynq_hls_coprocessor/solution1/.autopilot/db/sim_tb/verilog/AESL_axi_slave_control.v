...
//------------------------Parameter----------------------
`define TV_IN_A_0 "./c.eucDis.autotvin_A_0.dat"
`define TV_IN_A_1 "./c.eucDis.autotvin_A_1.dat"
`define TV_IN_A_2 "./c.eucDis.autotvin_A_2.dat"
`define TV_IN_A_3 "./c.eucDis.autotvin_A_3.dat"
`define TV_IN_A_4 "./c.eucDis.autotvin_A_4.dat"
`define TV_IN_A_5 "./c.eucDis.autotvin_A_5.dat"
`define TV_IN_A_6 "./c.eucDis.autotvin_A_6.dat"
`define TV_IN_A_7 "./c.eucDis.autotvin_A_7.dat"
`define TV_IN_B_0 "./c.eucDis.autotvin_B_0.dat"
`define TV_IN_B_1 "./c.eucDis.autotvin_B_1.dat"
`define TV_IN_B_2 "./c.eucDis.autotvin_B_2.dat"
`define TV_IN_B_3 "./c.eucDis.autotvin_B_3.dat"
`define TV_IN_B_4 "./c.eucDis.autotvin_B_4.dat"
`define TV_IN_B_5 "./c.eucDis.autotvin_B_5.dat"
`define TV_IN_B_6 "./c.eucDis.autotvin_B_6.dat"
`define TV_IN_B_7 "./c.eucDis.autotvin_B_7.dat"
`define TV_OUT_C "./rtl.eucDis.autotvout_C.dat"
