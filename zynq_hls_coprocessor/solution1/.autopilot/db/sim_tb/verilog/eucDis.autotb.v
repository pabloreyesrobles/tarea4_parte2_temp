...
`define AUTOTB_DUT      eucDis
`define AUTOTB_DUT_INST AESL_inst_eucDis
`define AUTOTB_TOP      apatb_eucDis_top
`define AUTOTB_LAT_RESULT_FILE "eucDis.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "eucDis.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_eucDis_top
...
`define AUTOTB_TVIN_A_0  "./c.eucDis.autotvin_A_0.dat"
`define AUTOTB_TVIN_A_1  "./c.eucDis.autotvin_A_1.dat"
`define AUTOTB_TVIN_A_2  "./c.eucDis.autotvin_A_2.dat"
`define AUTOTB_TVIN_A_3  "./c.eucDis.autotvin_A_3.dat"
`define AUTOTB_TVIN_A_4  "./c.eucDis.autotvin_A_4.dat"
`define AUTOTB_TVIN_A_5  "./c.eucDis.autotvin_A_5.dat"
`define AUTOTB_TVIN_A_6  "./c.eucDis.autotvin_A_6.dat"
`define AUTOTB_TVIN_A_7  "./c.eucDis.autotvin_A_7.dat"
`define AUTOTB_TVIN_B_0  "./c.eucDis.autotvin_B_0.dat"
`define AUTOTB_TVIN_B_1  "./c.eucDis.autotvin_B_1.dat"
`define AUTOTB_TVIN_B_2  "./c.eucDis.autotvin_B_2.dat"
`define AUTOTB_TVIN_B_3  "./c.eucDis.autotvin_B_3.dat"
`define AUTOTB_TVIN_B_4  "./c.eucDis.autotvin_B_4.dat"
`define AUTOTB_TVIN_B_5  "./c.eucDis.autotvin_B_5.dat"
`define AUTOTB_TVIN_B_6  "./c.eucDis.autotvin_B_6.dat"
`define AUTOTB_TVIN_B_7  "./c.eucDis.autotvin_B_7.dat"
`define AUTOTB_TVIN_A_0_out_wrapc  "./rtl.eucDis.autotvin_A_0.dat"
`define AUTOTB_TVIN_A_1_out_wrapc  "./rtl.eucDis.autotvin_A_1.dat"
`define AUTOTB_TVIN_A_2_out_wrapc  "./rtl.eucDis.autotvin_A_2.dat"
`define AUTOTB_TVIN_A_3_out_wrapc  "./rtl.eucDis.autotvin_A_3.dat"
`define AUTOTB_TVIN_A_4_out_wrapc  "./rtl.eucDis.autotvin_A_4.dat"
`define AUTOTB_TVIN_A_5_out_wrapc  "./rtl.eucDis.autotvin_A_5.dat"
`define AUTOTB_TVIN_A_6_out_wrapc  "./rtl.eucDis.autotvin_A_6.dat"
`define AUTOTB_TVIN_A_7_out_wrapc  "./rtl.eucDis.autotvin_A_7.dat"
`define AUTOTB_TVIN_B_0_out_wrapc  "./rtl.eucDis.autotvin_B_0.dat"
`define AUTOTB_TVIN_B_1_out_wrapc  "./rtl.eucDis.autotvin_B_1.dat"
`define AUTOTB_TVIN_B_2_out_wrapc  "./rtl.eucDis.autotvin_B_2.dat"
`define AUTOTB_TVIN_B_3_out_wrapc  "./rtl.eucDis.autotvin_B_3.dat"
`define AUTOTB_TVIN_B_4_out_wrapc  "./rtl.eucDis.autotvin_B_4.dat"
`define AUTOTB_TVIN_B_5_out_wrapc  "./rtl.eucDis.autotvin_B_5.dat"
`define AUTOTB_TVIN_B_6_out_wrapc  "./rtl.eucDis.autotvin_B_6.dat"
`define AUTOTB_TVIN_B_7_out_wrapc  "./rtl.eucDis.autotvin_B_7.dat"
`define AUTOTB_TVOUT_C  "./c.eucDis.autotvout_C.dat"
`define AUTOTB_TVOUT_C_out_wrapc  "./impl_rtl.eucDis.autotvout_C.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 144;
parameter LENGTH_A_0 = 128;
parameter LENGTH_A_1 = 128;
parameter LENGTH_A_2 = 128;
parameter LENGTH_A_3 = 128;
parameter LENGTH_A_4 = 128;
parameter LENGTH_A_5 = 128;
parameter LENGTH_A_6 = 128;
parameter LENGTH_A_7 = 128;
parameter LENGTH_B_0 = 128;
parameter LENGTH_B_1 = 128;
parameter LENGTH_B_2 = 128;
parameter LENGTH_B_3 = 128;
parameter LENGTH_B_4 = 128;
parameter LENGTH_B_5 = 128;
parameter LENGTH_B_6 = 128;
parameter LENGTH_B_7 = 128;
