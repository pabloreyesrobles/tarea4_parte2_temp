...
# ==============================================================
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vitis_HLS/2021.1/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vitis_HLS/2021.1/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vitis_HLS/2021.1/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vitis_HLS/2021.1/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "eucDis.autotvin.dat"
	set constFileTvOut       "eucDis.autotvout.dat"
	set constFileHdlTvIn     "eucDis.autohdltvin.dat"
	set constFileHdlTvOut    "eucDis.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
