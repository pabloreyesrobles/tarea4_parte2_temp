...
HD_PWD='E:/Magisterio/IPD-432/Tarea_4/zynq_coprocessor/zynq_coprocessor.runs/design_1_eucDis_0_5_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_eucDis_0_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_eucDis_0_5.tcl
